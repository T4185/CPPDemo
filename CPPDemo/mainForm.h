		...
		void InitializeComponent(void)
		{
			...
			this->listView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::ColumnHeader^  >(6) {
				this->columnHeader3, this->columnHeader1,
					this->columnHeader2, this->columnHeader4, this->columnHeader5, this->columnHeader6
			});
			...
			this->listView1->Size = System::Drawing::Size(363, 258);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(485, 113);
			...
			// columnHeader4
			// 
			this->columnHeader4->Text = L"NomUtilisateur";
			// 
			// columnHeader5
			// 
			this->columnHeader5->Text = L"MotPasse";
			// 
			// columnHeader6
			// 
			this->columnHeader6->Text = L"Admin";
			// 
			// mainForm
			// 
